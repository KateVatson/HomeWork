package ru.tieto.HomeWork.addressbook.generators;
  ...
  private List<ContactData> generateContacts(int count) {
    ...
    for (int i = 0; i < count; i++) {
      contacts.add(new ContactData().withFirstname(String.format("Pokemon %s", i))
             ...
             .withWorkPhone(String.format("223 22 %s", i)).withEmail(String.format("test_%s_@mir.ru", i)).withEmail2(String.format("dont_sleep_%s_@war.com", i)).withPhoto(new File ("src\\test\\resources/test.png")));
    }
    return contacts;
  }
}
