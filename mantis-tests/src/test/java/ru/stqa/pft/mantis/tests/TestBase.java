...
public class TestBase {
  ...
  public boolean isIssueOpen(int issueId) throws RemoteException, javax.xml.rpc.ServiceException, MalformedURLException {
    ...
    return issue.getResolution().getName().equals("open");
  }
